...
ggVennDiagram_plot = ggVennDiagram(list(ASVs_performes, ASVs_blenniiformes, ASVs_labriformes, ASVs_centrarchiformes), set_size = 6, category.names = c("Perciformes","Blenniiformes", "Labriformes", "Centrarchiformes") )

ggsave("../Core_Microbiome.png", plot = ggVennDiagram_plot, width = 10, height = 6, dpi = 300)
